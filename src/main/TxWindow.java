...
//					if(frame.getContentPane().getComponent(i) instanceof JList) {
//						jlist_id=i;
//						break;
//					}
//				}
//				if(jlist_id!=-1) {
//					frame.getContentPane().remove(jlist_id);
//				}
				//JList<Departamento> modulos_list = new JList<Modulo>(defModel);
//				JListAllDepts.setBounds(frame.getContentPane().getWidth() / 2, 0, frame.getContentPane().getWidth() / 2,
//						frame.getContentPane().getHeight() / 2);
//				frame.getContentPane().add(modulos_list);
